...
// import React, { useEffect, useState, useContext } from 'react';
// import { MapPin, GraduationCap, BookOpen, Calendar, Clock, UserCircle2, Briefcase, X, Send, Mail, Phone, Banknote } from 'lucide-react';
// // 🔴 Path check kore niben apnar folder structure onujayi
// import { AuthContext } from '../context/AuthProvider'; 
// import Swal from 'sweetalert2';
// import { useNavigate } from 'react-router-dom';
...
//             experience: form.experience.value,
//             qualifications: form.qualifications.value,
//             // 🔥 NEW FIELD: Tutor's requested salary
...
//                         <div className="bg-emerald-600 p-6 text-white flex justify-between items-center">
//                             <div>
//                                 <h3 className="font-bold text-lg">Tutor Application Form</h3>
//                                 <p className="text-xs opacity-80">Post: {selectedTuition.title}</p>
//                             </div>
//                             <button onClick={() => setSelectedTuition(null)} className="hover:bg-white/20 p-2 rounded-full transition-colors"><X /></button>
//                         </div>
//                         <form onSubmit={handleFormSubmit} className="p-8 space-y-4 max-h-[85vh] overflow-y-auto">
                            
//                             <div>
//                                 <label className="block text-xs font-bold text-gray-400 uppercase mb-1 ml-1">Tutor Email</label>
//                                 <div className="relative">
//                                     <Mail className="absolute left-3 top-3 text-gray-400" size={18} />
//                                     <input value={user?.email} readOnly className="w-full border-2 border-gray-100 p-3 pl-10 rounded-xl bg-gray-50 outline-none text-gray-500 cursor-not-allowed" />
//                                 </div>
//                             </div>

//                             <div>
//                                 <label className="block text-xs font-bold text-gray-400 uppercase mb-1 ml-1">Contact Number</label>
//                                 <div className="relative">
//                                     <Phone className="absolute left-3 top-3 text-gray-400" size={18} />
//                                     <input name="tutorPhone" type="tel" required placeholder="017XXXXXXXX" className="w-full border-2 border-gray-100 p-3 pl-10 rounded-xl outline-none focus:border-emerald-500 transition-colors" />
//                                 </div>
...
//                             <div>
//                                 <label className="block text-xs font-bold text-gray-400 uppercase mb-1 ml-1">Expected Salary (Monthly)</label>
//                                 <div className="relative">
//                                     <Banknote className="absolute left-3 top-3 text-gray-400" size={18} />
//                                     <input name="expectedSalary" type="number" required defaultValue={selectedTuition.salary} className="w-full border-2 border-gray-100 p-3 pl-10 rounded-xl outline-none focus:border-emerald-500 transition-colors font-bold text-emerald-700" />
//                                 </div>
//                             </div>

//                             <div>
//                                 <label className="block text-xs font-bold text-gray-400 uppercase mb-1 ml-1">Academic Qualifications</label>
//                                 <input name="qualifications" required placeholder="e.g. BSc in Math, University of Dhaka" className="w-full border-2 border-gray-100 p-3 rounded-xl outline-none focus:border-emerald-500 transition-colors" />
//                             </div>

//                             <div>
//                                 <label className="block text-xs font-bold text-gray-400 uppercase mb-1 ml-1">Relevant Experience</label>
//                                 <textarea name="experience" required rows="2" placeholder="Describe your teaching experience..." className="w-full border-2 border-gray-100 p-3 rounded-xl outline-none focus:border-emerald-500 transition-colors resize-none" />
//                             </div>
